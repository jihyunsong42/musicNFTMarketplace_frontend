...
This DApp(Decentralised Application) is Music NFT Marketplace, where customers can mint their music NFTs by uploading their soundtrack information.<br>Uploaded soundtrack will be minted to NFT(ERC-1155 Standard). Creators can determine how many NFTs they want to mint.<br>Once NFTs are minted, The creator can also upload their music NFTs on tradeblock.<br>This project was conducted with junior UI/UX Designer during Ethereum Hackathon. I took part of front-end and back-end logic on this project.<br>I also contributed to Smart Contract logic of this dApp. 
